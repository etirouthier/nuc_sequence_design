...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  4 16:34:16 2019
...
class Sequence:
    ...
    def mutated_seq_predictable(self):
        x_seq = self._mutated_process(self.mutated_seq)
        return x_seq
...
class Energy:
    ...
    def __init__(self, seq, model, y_target):
        ...
        self.single_prediction = self.model.predict(seq.seq_predictable)
        self.single_energy = self._get_one_energy(self.single_prediction)
        self.prediction = self.model.predict(seq.mutated_seq_predictable)
    ...
    def _get_energy_profile(self, y, seq):
        ...
        return GC_energy_1D + pred_energy
...
def _parse_arguments(args=None):
    ...
    parser.add_argument('-f', '--file',
                        help='''file containing the artificial sequences''')
